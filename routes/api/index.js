...
var productsRouter = require('./products/index');
var categoriesRouter = require('./categories/index');
...
router.use('/products',jwtMiddleware, productsRouter);
router.use('/categories', jwtMiddleware, categoriesRouter);
